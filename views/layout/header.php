<?php
require_once BASE_DIR . '/helpers/InformationModel.php';
$info = getSiteInfo(); 
...
<?php include __DIR__ . '/header/warning.php'; ?>
...
<?php include __DIR__ . '/header/login.php'; ?>

<!--Register Modal-->

<?php include __DIR__ . '/header/register.php'; ?>
