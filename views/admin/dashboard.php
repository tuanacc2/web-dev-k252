                                ...
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-package"></i> Products</div>
                                            <h2><?= htmlspecialchars(count($product)) ?></h2>
                                        </div>
                            ...
                            <div class="col-md-6 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-pencil-alt"></i> Posts </div>
                                            <h2><?= htmlspecialchars(count($post)) ?></h2>
                                        </div>
                            ...
                            <div class="col-md-6 mb-3 mb-lg-0">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-pulse"></i> Activities </div>
                                            <h2><?= htmlspecialchars(count($log)) ?></h2>
                                        </div>
                                        <canvas id="seolinechart2" height="50"></canvas>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="seo-fact sbg4">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <canvas id="seolinechart4" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
